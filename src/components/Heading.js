...
class Heading extends React.Component {
  handleSubmit = (event) => {
    ...
    if (code.includes(open_tag)){
      if (code.includes(close_tag)) {
        axios.put(`https://61293f58068adf001789b84b.mockapi.io/api/siswa/${id}`, { name, heading })
        .then(res => {
          alert("Sukses")
  ...
  componentDidMount() {
    axios.get(`https://61293f58068adf001789b84b.mockapi.io/api/siswa?heading=true`)
      .then(res => {
  ...
  return (
    ...
    <Form onSubmit={this.handleSubmit} className="py-3">
      <h2>Heading</h2>
        <p>Buatlah Penulisan Kode Heading Terbesar atau H1 HTML Pada Form Di Bawah! <br/>Note: Jangan Menggunakan Attribut Lain Seperti Id/Class.</p>
        <Row>
        <Col sm="auto">
        <Form.Control
          type="text"
